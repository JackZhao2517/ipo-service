...
public class CompanyService {
	...
	public CommonResult deleteCompanyById(Integer cpId) {
		try {
			companyRepository.deleteCompanyById(cpId);
			return CommonResult.build(200, "deleteCompany success!");
		} catch (Exception e) {
			logger.error("Fail to deleteCompanyById data:", e);
			return CommonResult.build(ResponseCode.ERROR_ACCESS_DB, "DB ERROR!");
		}
	}
}
