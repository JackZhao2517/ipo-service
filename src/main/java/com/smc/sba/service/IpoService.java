...
public class IpoService {
	...
	public CommonResult deleteIPOByName(String companyName) {
		try {
			repository.deleteIPOByName(companyName);
			return CommonResult.build(200, "deleteIPOByName success!");
		} catch (Exception e) {
			logger.error("Fail to deleteIPOByName data:", e);
			return CommonResult.build(ResponseCode.ERROR_ACCESS_DB, "DB ERROR!");
		}
	}
}
