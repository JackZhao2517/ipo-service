...
//	public CommonResult deleteCompanyById(@RequestParam("companyid") Integer companyid) {
//		return companyService.deleteCompanyById(companyid);
//	}
	
	@PostMapping("/delcompany")
	public CommonResult deleteCompanyById(@RequestBody CompanyEntity companyDtl) {
		return companyService.deleteCompanyById(companyDtl.getCompanyid());
	}
